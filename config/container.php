...
use Module5Project\Repository\CategoryRepositoryFromDoctrine;
use Module5Project\Repository\PostRepositoryFromDoctrine;
use Module5Project\Repository\PostsCategoriesRepositoryFromDoctrine;
...
$container->set('post-repository', static function (Container $c){
    ...
    return new PostRepositoryFromDoctrine($entityManager);
});

$container->set('category-repository', static function (Container $c){
    $entityManager = $c->get(EntityManager::class);
    return new CategoryRepositoryFromDoctrine($entityManager);
});
